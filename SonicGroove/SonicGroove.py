...
dpg.create_context()
dpg.create_viewport(title="SonicGroove",large_icon="icon.ico",small_icon="icon.ico")
pygame.mixer.init()
...
def update_slider():
	global state_event
	while pygame.mixer.music.get_busy() or state_event.is_set():
...
def play_pause():
	...
	with state_lock:
		if state == "playing":
			...
			if pygame.mixer.music.get_busy():
				dpg.configure_item("csong", default_value=f"Now Playing : {ntpath.basename(no)}")
				thread = threading.Thread(target=update_slider, daemon=False)
				thread.start()
...
with dpg.theme(tag="base"):
    with dpg.theme_component():
        dpg.add_theme_color(dpg.mvThemeCol_Button, (1, 187, 78))  # Change button color to green (01BB4E)
        dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, (21, 40, 26))
        dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (0, 62, 26))
        dpg.add_theme_color(dpg.mvThemeCol_Text, (255, 255, 255))  # Change text color to white
        ...
        dpg.add_theme_color(dpg.mvThemeCol_ChildBg, (9, 9, 9))  # Change background color to dark brown (181413)
        dpg.add_theme_color(dpg.mvThemeCol_Border, (51, 51, 55))  # Change border color to white (transparent)
        dpg.add_theme_color(dpg.mvThemeCol_ScrollbarBg, (51, 51, 55))  # Change scrollbar background color to white (transparent)
        dpg.add_theme_color(dpg.mvThemeCol_TitleBgActive, (130, 142, 250))
        dpg.add_theme_color(dpg.mvThemeCol_CheckMark, (221, 166, 185))
        dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (38, 38, 38))

with dpg.theme(tag="slider_thin"):
	with dpg.theme_component():
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (34, 71, 49))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (34, 71, 49))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrabActive, (22, 47, 32))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrab, (22, 47, 32))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBg, (17, 129, 63))
...
with dpg.theme(tag="songs"):
	with dpg.theme_component():
		...
		dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (105, 105, 105))
